...
#from django.contrib.auth import django_registration

# Register your models here.
from .models import  MyProfile, MyPost, MyComment, PostLike, FollowUser
...
class MyCommentAdmin(ModelAdmin):
...
#admin.site.register(django_registration)
